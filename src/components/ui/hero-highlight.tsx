...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-orange-500 to-orange-400`,
        className,
      )}
      //  `relative inline-block rounded-lg bg-gradient-to-r from-orange-500 to-orange-600 shadow-lg hover:from-orange-600 hover:to-orange-100`,
    >
      {children}
    </motion.span>
  );
